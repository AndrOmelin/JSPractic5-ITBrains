...
console.log("sumArray([1, 2, 3, 4, 5])", sumArray([1, 2, 3, 4, 5])); // Виведе 15
 ...
 //function findMinMax([firstElement, ...restElements]) {
  function findMinMax([firstElement, ...restElements]) {
    // Ініціалізуємо змінні для мінімального
       let min = firstElement;
    //та максимального значень, задаємо їм перше значення масиву
...
// Завдання 11: Функція приймає масив чисел.
// Поверніть новий масив, який містить тільки парні числа з оригінального масиву.
 function getEvenNumbers(arr) {
   // Створюємо пустий масив для зберігання результату
   let evenNumbers = [];
   // Проходимо через кожен елемент вхідного масиву
   for (let i = 0; i < arr.length; i++) {
     // Перевіряємо чи є поточний елемент парним числом
     if (arr[i] % 2 === 0) {
       // Якщо так, додаємо його до масиву результату
       evenNumbers.push(arr[i]);
     }
   }
   // Повертаємо масив результату, що містить тільки парні числа
   return evenNumbers;
 }
 ...
 console.log(multiplyByIndex([1, 2, 3, 4, 5])); // Виведе [0, 2, 6, 12, 20]
      ...
      // Завдання 13: Функція приймає масив чисел.
      // Повертає новий масив, в якому всі числа більші за 10 замінені на рядок "Greater than 10",
